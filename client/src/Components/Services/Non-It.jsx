...
import photo11 from '../Photos/Voice-process.jpg';
    ...
    return (
        <>
            ...
            <div className="test2-services-svs" >
                <h1 className="top-services-heading-svs">Non-IT Services</h1>
            </div>
                ...
                <div className="container-svs">
                                ...
                                <div className="col-12-svs col-lg-8-svs services-top-one">
                                    <div className="service-details-items-svs">
                                        ...
                                        <div className="details-content">
                                            <h2>"Your Digital Presence Is Your Virtual Storefront; Elevate It With IMS's Expert Design And Development Solutions."</h2>
                                            <h3><b>"Let's Craft A Distinctive Online Platform For Maximizing Conversions."</b></h3>
                                            <p>
                                            In the current digital era, a website serves as more than just an online representation; it's a vital element for every business. At IMS, each website we develop is tailor-made to cater to our clients' individual requirements. Our objective is to craft a website that embodies your brand's identity and provides an outstanding user journey for your clientele.
                                            </p>
                                            <br />
                                            <p>Our offerings extend beyond mere website creation. We adopt a comprehensive strategy towards digital marketing, aimed at bolstering your online visibility and achieving your business objectives.</p>
                                    ...
                                    <div className="main-sidebar bg-container-svs">
                                        <div className="single-sidebar-widget">
                                            ...
                                            <div className="service-category">
                                                ...
                                                <a href="Non-IT Services" className="active">
                                                    <div className="arrow-icons-services">
                                                        <div>
                                                            Non-IT Services
                                                        </div>
                    ...
                    <div className="bottom-part-last-services" style={{ padding: '3%', margin: '0px' }}>
                        ...
                        <div className="jumping-bg-container">
                            <div className="services-group-img66">
