...
import "./MoblieApplicationDev.css";
import "./Services.css";
import { TabView, TabPanel } from 'primereact/tabview';
import { IoStar } from "react-icons/io5";
import { FaAngleLeft } from "react-icons/fa6";
import photo1 from "../Photos/96953.jpg"
    ...
    return (
        <>
            ...
            <div className="test2-services-svs" >
                <h1 className="top-services-heading-svs">Mobile Application Development</h1>
            </div>
                ...
                <div className="container-svs">
                                ...
                                <div className="col-12-svs col-lg-8-svs services-top-one">
                                    <div className="service-details-items-svs">
                                        ...
                                        <div className="details-content">
                                            <h2>"Your Mobile App Is Your Pocket-Sized Storefront; Elevate It With Expert Development By IMS."</h2>
                                            <h3><b>Let's Build A Unique Mobile Application For Higher Conversions.</b></h3>
                                            <p>
                                    ...
                                    <div className="main-sidebar bg-container-svs">
                                        <div className="single-sidebar-widget">
                                            ...
                                            <div className="service-category">
                                                ...
                                                <a href="Mobile Application Development" className="active">
                                                    <div className="arrow-icons-services">
                                                        <div>
                    ...
                    <div className="bottom-part-last-services" style={{ padding: '3%', margin: '0px' }}>
                                    ...
                                    <TabView >
                                        <TabPanel header="Our Approach" className="" style={{ textDecoration: 'none' }}>
                                            ...
                                            <div className='our-approch-content'>
                                                <div className='our-approch-para'>
                                                    <p className="m-0">
                                                    Understanding the purpose, target audience, and required functionality is crucial for mobile application development. Here's how we approach gathering detailed requirements
                                                    </p>
                                                </div>
                                        ...
                                        <TabPanel header="Project Goals">
                                            ...
                                            <div className='our-approch-content'>
                                                <div className='our-approch-para'>
                                                    <p className="m-0">
                                                    Your mobile application is an integral part of your brand's identity. It should encapsulate your brand's visual aesthetics and messaging while instilling confidence and reliance in your intended users. Our mobile application development services go beyond mere app creation. We adopt a comprehensive approach to digital marketing, ensuring that our services empower you to expand your online footprint and achieve your business objectives.
                                                    </p>
                                                </div>
                                                <div className='our-approch-list'>
                                                    <ul className='our-approch-right-side'>
                        ...
                        <div className="jumping-bg-container">
                            <div className="services-group-img-mobile">
...
export default MoblieApplicationDev;