...
import photo1 from "../Photos/2000008.png"
    ...
    return (
        <>
            ...
            <div className="test2-services-svs" >
                <h1 className="top-services-heading-svs">HR Services</h1>
            </div>
                ...
                <div className="container-svs">
                                ...
                                <div className="col-12-svs col-lg-8-svs services-top-one">
                                    <div className="service-details-items-svs">
                                        ...
                                        <div className="details-content">
                                            <h2>"Your HR Platform Is Your Digital Front Door; Elevate It With IMS's Expertise."</h2>
                                            <h3><b>"Let's Create A Distinctive HR Platform For Optimal Outcomes."</b></h3>
                                            <p>
                                    ...
                                    <div className="main-sidebar bg-container-svs">
                                        <div className="single-sidebar-widget">
                                            ...
                                            <div className="service-category">
                                                ...
                                                <a href="HR Services" className="active">
                                                    <div className="arrow-icons-services">
                                                        <div>
                                                            HR Services
                                                        </div>
                    ...
                    <div className="bottom-part-last-services" style={{ padding: '3%', margin: '0px' }}>
                                    ...
                                    <TabView >
                                        <TabPanel header="Our Approach" className="" style={{ textDecoration: 'none' }}>
                                            ...
                                            <div className='our-approch-content'>
                                                <div className='our-approch-para'>
                                                    <p className="m-0">
                                                    Understand the purpose of the website. What is its primary goal? Who is the target audience? What functionality is required? Gathering detailed requirements helps in creating a roadmap for development.
                                                    </p>
                                                </div>
                                                <div className='our-approch-list'>
                                                    <ul className='our-approch-right-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Exploration and Assessment</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Strategizing and Blueprinting</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Crafting & Implementation</b></p>

                                                    </ul>
                                                    <ul className='our-approch-left-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /> </span>&nbsp;<b>Evaluation and Quality Assurance</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span> &nbsp;<b>Fine-tuning after Launch</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span> &nbsp;<b>Sustaining and Enhancing</b></p>
                                                    </ul>
                                                </div>
                                        ...
                                        <TabPanel header="Project Goals">
                                            ...
                                            <div className='our-approch-content'>
                                                <div className='our-approch-para'>
                                                    <p className="m-0">
                                                    Your HR platform is a pivotal element of your brand identity. It should encapsulate your brand's visual style and messaging, instilling trust and reliability among your intended audience. Our HR solutions extend beyond platform creation, encompassing a holistic digital marketing strategy tailored to bolster your online presence and achieve your organizational objectives.
                                                    </p>
                                                </div>
                                                <div className='our-approch-list'>
                                                    <ul className='our-approch-right-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Search Engine Optimized</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>User-Centric Design</b></p>
                                                    </ul>
                                                    <ul className='our-approch-left-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Functional & Elegant</b></p>
                        ...
                        <div className="jumping-bg-container">
                            <div className="services-group-img-HR">
                            ...
                            <div className="single-news-items">
                                <div className="bottom-services-anchor">
                                    <p> <a href="#0" className="services-bottom-underline-text-svs">IT Service Case Studies Accelerating Business Fly Success Tech</a> </p>
                                </div>
