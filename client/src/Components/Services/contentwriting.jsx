...
import photo1 from "../Photos/content.jpg"
    ...
    return (
        <>
            ...
            <div className="test2-services-svs" >
                <h1 className="top-services-heading-svs">Content Writing And Moderation</h1>
            </div>
                ...
                <div className="container-svs">
                                ...
                                <div className="col-12-svs col-lg-8-svs services-top-one">
                                    <div className="service-details-items-svs">
                                        ...
                                        <div className="details-content">
                                            <h2>"Access A Full Suite Of Content Moderation Services Trusted By IMS And Customise To Your Needs"</h2>
                                            <h3><b>Setting The Standard In Trust And Safety With Expert Consulting</b></h3>
                                            <p>
                                            In a highly competitive online marketplace, your online content can help you stand out. Our scalable and multilingual content solutions are designed to protect your brand’s image and your customers at any time, in any online platform.
                                            </p>
                                            <br />
                                            <p>Our team produces original and engaging content for your website and social media pages to reflect your branding and resonate with your audience.We moderate all types of content to keep your social media pages, blogs, and website safe and engaging for every user..</p>
                                    ...
                                    <div className="main-sidebar bg-container-svs">
                                        <div className="single-sidebar-widget">
                                            ...
                                            <div className="service-category">
                                                ...
                                                <a href="Content Writing and Moderation" className="active">
                                                    <div className="arrow-icons-services">
                                                        <div>
                    ...
                    <div className="bottom-part-last-services" style={{ padding: '3%', margin: '0px' }}>
                            ...
                            <div>
                                <div className='our-projects-div'>
                                    ...
                                    <div className='happy-clients-heading-div'>
                                        <h3 className='happy-clients-heading'>Our Happy Clients Projects</h3>
                                    </div>
                                </div>
                                    ...
                                    <TabView >
                                        <TabPanel header="Our Approach" className="" style={{ textDecoration: 'none' }}>
                                            ...
                                            <div className='our-approch-content'>
                                                <div className='our-approch-para'>
                                                    <p className="m-0">
                                                    Smart and engaging content helps build user trust. This is why we train our people rigorously to deliver 100% adherence with your content style guide and quality standards.
                                                    </p>
                                                </div>
                                                <div className='our-approch-list'>
                                                    <ul className='our-approch-right-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Strategy Development</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Content Creation</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Implementation and Monitoring</b></p>

                                                    </ul>
                                                    <ul className='our-approch-left-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /> </span>&nbsp;<b>Reporting and Optimization</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span> &nbsp;<b>Establish Clear Guidelines</b></p>
                                        ...
                                        <TabPanel header="Project Goals">
                                            ...
                                            <div className='our-approch-content'>
                                                <div className='our-approch-para'>
                                                    <p className="m-0">
                                                    Creating high-quality, engaging content that aligns with the company's brand identity, values, and target audience preferences, while also addressing their informational needs and interests
                                                    </p>
                                                </div>
                                                <div className='our-approch-list'>
                                                    <ul className='our-approch-right-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Quality Content Creation</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Consistent Publishing</b></p>
                                                    </ul>
                                                    <ul className='our-approch-left-side'>
                                                        <p><span className='our-approch-icon'><FaCheck /></span>&nbsp;<b>Efficient Moderation</b></p>
                                                        <p><span className='our-approch-icon'><FaCheck /></span> &nbsp;<b>Performance Optimization</b></p>
                                                    </ul>
                                                </div>
                                                <div className="our-approch-button-div">
                        ...
                        <div className="jumping-bg-container">
                            <div className="services-group-img22">
